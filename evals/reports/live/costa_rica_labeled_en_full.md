...
- Run ID: `costa_rica_labeled_en_full`
- Trace JSON: `/home/arthur/Documents/gail/upr-matcher/evals/traces/live/costa_rica_labeled_en_full.json`
- Source mode: `gold`
- Source language: `en`
...
- `source_pdf_text_extraction`: 0.503s
- `reference_text_extraction`: 0.328s
- `reference_doc_row_extraction`: 0.331s
- `reference_embedding`: 57.877s
- `source_embedding`: 1.1s
- `semantic_candidate_matching`: 0.951s
- `reranking`: 2.746s
