...
- Run ID: `costa_rica_parser_regression_es_gold`
- Trace JSON: `/home/arthur/Documents/gail/upr-matcher/evals/traces/live/costa_rica_parser_regression_es_gold.json`
- Source mode: `gold`
- Source language: `es`
...
- `source_pdf_text_extraction`: 0.485s
- `reference_text_extraction`: 0.326s
- `reference_doc_row_extraction`: 0.314s
- `reference_embedding`: 55.948s
- `source_embedding`: 1.857s
- `semantic_candidate_matching`: 1.086s
