...
- Run ID: `pr1_qwen8b_threshold_0.6_es`
- Trace JSON: `/tmp/upr-matcher-pr1/evals/traces/live/pr1_qwen8b_threshold_0.6_es.json`
- Source mode: `gold`
- Source language: `es`
...
- `source_pdf_text_extraction`: 0.589s
- `reference_text_extraction`: 0.344s
- `reference_doc_row_extraction`: 0.346s
- `reference_embedding`: 29.79s
- `source_embedding`: 3.203s
- `semantic_candidate_matching`: 5.649s
